            ...
            <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td data-column="Role"><?php echo $row["role"] ?></td>
                            <td data-column="Birthday"><?php echo $newdate ?></td>
                            ...
                            <?php if ($status ==1) { ?>
                                <a class="btn btn-danger action-button" href="empinactive.php?id=<?php echo $row["id"]?>" role="button">Inactive</a>
                            <?php } ?>
                            <?php if ($status ==0) { ?>
                                <a class="btn btn-success action-button" href="empactive.php?id=<?php echo $row["id"]?>" role="button">Active</a>
