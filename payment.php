<?php
    ...
    if (isset($_POST['submit-next'])) {
        ...
        if($quantity >$oriquantity){
            $quantity_error = "Sorry Quantity Can't be more than $oriquantity KG";
        }
        else{
            header("Location: paymentcon.php?id=$id&quantity=$quantity&total=$total");
        }
  ...
  <div id="column-left" class="col-sm-3 hidden-xs column-left">
    ...
    <div id="content" class="col-sm-9">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="number" name="quantity" class="form-control" id="" placeholder="Enter Quantity (KG)" required>
                </div>
                <button type="submit" name="submit-next" class="btn btn-primary">Next</button>
